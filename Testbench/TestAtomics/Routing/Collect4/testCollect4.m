function [out]= testCollect4(showPlot)
  ...
  Collect4 = devs(am_collect4("Collect4", [0, 10], [0, 10], mdebug));
  ...
  N1.add_coupling("Generator1","out","Collect4","in1");
  N1.add_coupling("Generator2","out","Collect4","in2");
  N1.add_coupling("Generator3","out","Collect4","in3");
  N1.add_coupling("Generator4","out","Collect4","in4");
  N1.add_coupling("Collect4","out","Terminator1","in");
  ...
  N1.add_coupling("Collect4","out","Combout","in");
