function [out] = testMult2(showPlot)
	if nargin == 0
      showPlot = false;
    end
    ...
    Mult2 = devs(am_mult2("Mult2", [0, 1], mdebug));
    ...
    N1.add_coupling("Vectorgen1","out","Mult2","in1");
    N1.add_coupling("Vectorgen2","out","Mult2","in2");
    N1.add_coupling("Mult2","out","Terminator1","in");
    N1.add_coupling("Vectorgen1","out","Gen1out","in");
    N1.add_coupling("Vectorgen2","out","Gen2out","in");
    N1.add_coupling("Mult2","out","Multiout","in");
    ...
    if showPlot
        figure("name", "testMult2", "NumberTitle", "off", "Position", [1 1 450 500]);
        subplot(3,1,1)
