function [out] = testMult3(showPlot)
    ...
    Mult3 = devs(am_mult3("Mult3", [0, 1], mdebug));
    ...
    N1.add_coupling("Vectorgen1","out","Mult3","in1");
    N1.add_coupling("Vectorgen2","out","Mult3","in2");
    N1.add_coupling("Vectorgen3","out","Mult3","in3");
    N1.add_coupling("Mult3","out","Terminator1","in");
    ...
    N1.add_coupling("Mult3","out","Multiout","in");
