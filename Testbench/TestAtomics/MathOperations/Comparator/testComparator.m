function [out] = testComparator(showPlot)
  ...
  if showPlot
    ...
    subplot(7,1,2)
    stairs(simout.compOut1.t, simout.compOut1.y);
    grid("on");
    xlim([0, tEnd])
    xlabel("simulation time");
    ylabel("out");
    ...
    subplot(7,1,3)
    stairs(simout.compOut2.t, simout.compOut2.y);
    grid("on");
    xlim([0, tEnd])
    xlabel("simulation time");
    ylabel("out");
    ...
    subplot(7,1,4)
    stairs(simout.compOut3.t, simout.compOut3.y);
    grid("on");
    xlim([0, tEnd])
    xlabel("simulation time");
    ylabel("out");
    ...
    subplot(7,1,5)
    stairs(simout.compOut4.t, simout.compOut4.y);
    grid("on");
    xlim([0, tEnd])
    xlabel("simulation time");
    ylabel("out");
    ...
    subplot(7,1,6)
    stairs(simout.compOut5.t, simout.compOut5.y);
    grid("on");
    xlim([0, tEnd])
    xlabel("simulation time");
    ylabel("out");
    ...
    subplot(7,1,7)
    stairs(simout.compOut6.t, simout.compOut6.y);
    grid("on");
    xlim([0, tEnd])
    xlabel("simulation time");
    ylabel("out");
