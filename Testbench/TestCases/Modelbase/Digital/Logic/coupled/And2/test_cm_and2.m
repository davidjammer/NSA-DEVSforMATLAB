function out = test_cm_and2(showPlot)
    ...
    Nandout = devs(am_toworkspace("andout", "andOut", 0, "vector", [0, rOut], mdebug));
    ...
    N1.add_coupling("and2","out","Terminator1","in");
    ...
    if showPlot
        ...
        subplot(3,1,3)
        plot_ieee1164(simout.andOut.t, simout.andOut.y);
        title("Y");
        xlim([0,16])
        xlabel('t');
        grid on;
