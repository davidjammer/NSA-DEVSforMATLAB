function [out] = testAdd4(showPlot)
    ...
    Add4 = devs(am_add4("Add4", [0, 1], mdebug));
    ...
    N1.add_coupling("Vectorgen1","out","Add4","in1");
    N1.add_coupling("Vectorgen2","out","Add4","in2");
    N1.add_coupling("Vectorgen3","out","Add4","in3");
    N1.add_coupling("Vectorgen4","out","Add4","in4");
    N1.add_coupling("Add4","out","Terminator1","in");
    ...
    N1.add_coupling("Add4","out","Addout","in");
