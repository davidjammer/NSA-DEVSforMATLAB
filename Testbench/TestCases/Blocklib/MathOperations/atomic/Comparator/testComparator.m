function [out] = testComparator(showPlot)
    ...
    if showPlot
        ...
        subplot(7,1,2)
		plot_ieee1164(out.compOut1.t, out.compOut1.y);
        grid("on");
        xlim([0, tEnd])
        xlabel("simulation time");
        ylabel("out");
        ...
        subplot(7,1,3)
		plot_ieee1164(out.compOut2.t, out.compOut2.y);
        grid("on");
        xlim([0, tEnd])
        xlabel("simulation time");
        ylabel("out");
        ...
        subplot(7,1,4)
		plot_ieee1164(out.compOut3.t, out.compOut3.y);
        grid("on");
        xlim([0, tEnd])
        xlabel("simulation time");
        ylabel("out");
        ...
        subplot(7,1,5)
		plot_ieee1164(out.compOut4.t, out.compOut4.y);
        grid("on");
        xlim([0, tEnd])
        xlabel("simulation time");
        ylabel("out");
        ...
        subplot(7,1,6)
		plot_ieee1164(out.compOut5.t, out.compOut5.y);
        grid("on");
        xlim([0, tEnd])
        xlabel("simulation time");
        ylabel("out");
        ...
        subplot(7,1,7)
		plot_ieee1164(out.compOut6.t, out.compOut6.y);
        grid("on");
        xlim([0, tEnd])
        xlabel("simulation time");
        ylabel("out");
