...
subplot(6,1,1)
plot_ieee1164(out.bin1Out.t,out.bin1Out.y);
title("In");
xlim([0, tEnd])

subplot(6,1,2)
plot_ieee1164(out.bin2Out.t,out.bin2Out.y);
title("CLK");
xlim([0, tEnd])

subplot(6,1,3)
plot_ieee1164(out.q1Out.t,out.q1Out.y);
title("Out 1");
xlim([0, tEnd])

subplot(6,1,4)
plot_ieee1164(out.q2Out.t,out.q2Out.y);
title("Out 2");
xlim([0, tEnd])

subplot(6,1,5)
plot_ieee1164(out.q3Out.t,out.q3Out.y);
title("Out 3");
xlim([0, tEnd])

subplot(6,1,6)
plot_ieee1164(out.q4Out.t,out.q4Out.y);
title("Out 4");
xlim([0, tEnd])
end
