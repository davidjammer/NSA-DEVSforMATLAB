function [out] = testUtilization(tEnd)
global simout
global epsilon
global DEBUGLEVEL
global mi
...
Queue = devs(queue("Queue", [0,2], [0,2], mdebug));
...
SrvNOut = devs(toworkspace("SrvNOut", "srvnOut", 0,"vector",[0,rOut], 0));
utilOut = devs(toworkspace("utilOut", "utilOut", 0,"vector",[0,rOut], 0));
