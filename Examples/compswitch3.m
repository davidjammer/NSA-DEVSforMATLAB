function [out] = compswitch3(tend)
    % compswitch1 with additional delay befor T1
    global simout
    global epsilon
    global DEBUGLEVEL
    global mi
    ...
    Gain = devs(gain("D", 1, [0, rD], mdebug));   % additional delay
    ...
    N.add_coupling("S","out1","D","in");
    N.add_coupling("D","out","T1","in");
