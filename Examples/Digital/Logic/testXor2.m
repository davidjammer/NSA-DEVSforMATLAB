...
Xorout = devs(toworkspace("Xorout", "xorOut", 0, [0, rOut]));
...
N1.add_coupling("Vectorgen1","out","xor","in1");
N1.add_coupling("Vectorgen2","out","xor","in2");
N1.add_coupling("xor","out","Terminator1","in");
N1.add_coupling("Vectorgen1","out","Gen1out","in");
N1.add_coupling("Vectorgen2","out","Gen2out","in");
N1.add_coupling("xor","out","Xorout","in");

root = rootcoordinator("root",0,tEnd,N1,0);
root.sim();

figure("name", "testXor2", "NumberTitle", "off", "Position", [1 1 450 500]);
subplot(4,1,1)
...
subplot(4,1,3)
stairs(simout.xorOut.t,simout.xorOut.y,'-*');
title("xor2");
xlim([0,16])
ylim([0,1.3])
