...
Binout1 = devs(toworkspace("Binout1", "bin1Out", 0, [0,rOut]));
Binout2 = devs(toworkspace("Binout2", "bin2Out", 0, [0,rOut]));
JKFFq1 = devs(toworkspace("JKFFq1", "q1Out", 0, [0,rOut]));
JKFFq2 = devs(toworkspace("JKFFq2", "q2Out", 0, [0,rOut]));
JKFFq3 = devs(toworkspace("JKFFq3", "q3Out", 0, [0,rOut]));
JKFFq4 = devs(toworkspace("JKFFq4", "q4Out", 0, [0,rOut]));
